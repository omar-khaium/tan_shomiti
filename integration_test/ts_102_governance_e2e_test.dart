...
void main() {
  patrolTest(
    'ts102 e2e: roles + sign-off write audit events',
    ($) async {
      ...
      // Ensure we start from a deterministic, small-member setup.
      ...
      expect(find.text('assigned_role'), findsWidgets);
      expect(find.text('recorded_member_consent'), findsWidgets);
    },
  );
}
